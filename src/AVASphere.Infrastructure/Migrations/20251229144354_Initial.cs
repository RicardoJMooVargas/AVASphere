        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdIndividualProjectQuote = table.Column<int>(type: "integer", nullable: false),
                    IdPropertyValue = table.Column<int>(type: "integer", nullable: false),
                    PropertyValueIdPropertyValue = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_IndividualListingProperties_PropertyValue_IdPropertyValue",
                        column: x => x.IdPropertyValue,
                        principalTable: "PropertyValue",
                        principalColumn: "IdPropertyValue",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_IndividualListingProperties_PropertyValue_PropertyValueIdPr~",
                        column: x => x.PropertyValueIdPropertyValue,
                        principalTable: "PropertyValue",
                        principalColumn: "IdPropertyValue");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IndividualListingProperties_IdPropertyValue",
                table: "IndividualListingProperties",
                column: "IdPropertyValue");

            migrationBuilder.CreateIndex(
                name: "IX_IndividualListingProperties_PropertyValueIdPropertyValue",
                table: "IndividualListingProperties",
                column: "PropertyValueIdPropertyValue");
