...
/// <summary>
/// Repositorio para operaciones de persistencia y consulta sobre la entidad <see cref="Users"/>.
/// </summary>
/// <remarks>
/// Esta interfaz define las operaciones básicas que deben implementar las capas de acceso a datos
/// para la entidad Users. La documentación de cada método explica la semántica esperada; las implementaciones
...
public interface IUsersRepository
{
    ...
    /// - Campos de ejemplo que pueden usarse como filtro: Id, Username, Email, Phone, etc. (dependiendo de los campos de la entidad <see cref="Users"/>).
    ...
    /// </remarks>
    /// <param name="user">Objeto <see cref="Users"/> que contiene uno o varios campos usados como criterios de búsqueda.</param>
    /// <returns>
    /// Una tarea que resuelve en la entidad <see cref="Users"/> encontrada que cumple los criterios, o <c>null</c> si no existe ninguna.
    /// </returns>
    /// <exception cref="ArgumentNullException">Si <paramref name="user"/> es <c>null</c>.</exception>
    Task<Users> SelectUserAsync(Users user);

    /// <summary>
    /// Obtiene un usuario por su identificador único.
    /// </summary>
    /// <param name="idUsers">Identificador del usuario.</param>
    /// <returns>Una tarea que resuelve en la entidad <see cref="Users"/> o <c>null</c> si no existe.</returns>
    Task<Users> SelectByIdAsync(int idUsers);   

    /// <summary>
    /// Crea un nuevo usuario en la persistencia.
    /// </summary>
    /// <param name="user">Entidad <see cref="Users"/> a crear. No debe ser <c>null</c>.</param>
    ...
    /// </summary>
    /// <param name="user">Entidad <see cref="Users"/> con los datos a actualizar. Debe contener el identificador del usuario.</param>
    /// <returns>Una tarea que representa la operación asíncrona.</returns>
